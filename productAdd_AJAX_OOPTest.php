...
$insert = "INSERT INTO scandiweb(sku, name, price, weight, height, length, width, size) VALUES ('$sku', '$product_name', '$price', '$weight', '$height', '$length', '$width', '$size')";
$result = mysqli_query($this->conn, $insert); 
  if( $result) {
printf("<p> Product saved by server</p>");
echo "<meta http-equiv='refresh' content='1;url=https://plutobakery.000webhostapp.com/Scandiweb/Product_List_Test.php'>";
  }
else {
